...
java -jar ./conveyor-cli/build/libs/conveyor-cli-1.0.0-standalone.jar ./conveyor.json clean publish
rm -r ./.gradle-repository
mv ./conveyor-cli/.conveyor/conveyor-cli-1.0.0-executable.jar ./conveyor-cli-1.0.0-executable.jar
java -jar ./conveyor-cli-1.0.0-executable.jar ./conveyor.json clean publish
mv ./conveyor-cli/.conveyor/conveyor-cli-1.0.0-executable.jar ./conveyor-cli-1.0.0-executable.jar
